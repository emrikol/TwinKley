...
### Fixed
- Auto-update now works correctly (XPC service identifiers were being overwritten during code signing)

### Changed
- Code signing no longer uses `--identifier` flag with `--deep`, preserving nested component identifiers
